...
signal connect_to_server_pressed(ip : String)
...
# INFO menu hierarchy sheme
# 1. gamemode_menu -> (singleplayer) -> setup_player_menu -> game_scene
#                  -> (multiplayer)  -> server_client_menu
#
# 2. server_client_menu -> (run server) -> (success) -> popup & multiplayer_menu
#                                       -> (error)   -> popup & server_client_menu
#                       -> (connect to server) -> servers_browser
#
# 3. servers_browser -> (join) -> (success) -> popup & multiplayer_menu
#                              -> (error)   -> popup & server_client_menu
#
# 4. multiplayer_menu -> (create room) -> (success) -> popup & player_setup -> web_lobby
#                                      -> (error)   -> popup & multiplayer_menu
#                     -> (join room) -> (success) -> popup & 
...
func _multiplayer_menu_create_room_pressed() -> void:
	#TODO rework create room popup ui
	pass
...
func _servers_browser_join_pressed(ip : String) -> void:
	connect_to_server_pressed.emit(ip)
	_multiplayer_menu_open()
